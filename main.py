...
Πώς λειτουργεί
Το σύστημα βασίζεται στην επεξεργασία δεδομένων πραγματικού χρόνου. Μέσω ενός αυτοματοποιημένου αλγορίθμου, το VineWatch αντλεί μετεωρολογικά δεδομένα (θερμοκρασία, υγρασία, ένταση ανέμων) για την ευρύτερη περιοχή της Τρίπολης. Στη συνέχεια, τα δεδομένα αυτά συγκρίνονται με διεθνώς αναγνωρισμένα γεωπονικά όρια (thresholds) που ευνοούν την ανάπτυξη μυκητολογικών ασθενειών.
