...
# Λίστα με δημοφιλείς παραλίες, συντεταγμένες και τον προσανατολισμό τους (orientation)
# Orientation: 0=Βορράς, 90=Ανατολή, 180=Νότος, 270=Δύση
beaches = {
    # Παραλίες Αρκαδίας (Μυρτώο Πέλαγος)
    "Άγιος Ανδρέας (Αρκαδία)": {"lat": 37.345, "lon": 22.775, "orientation": 80},
    "Κρυονέρι (Αρκαδία)": {"lat": 37.318, "lon": 22.812, "orientation": 100},
    "Ζαρίτσι (Τυρός)": {"lat": 37.285, "lon": 22.845, "orientation": 105},
    "Πλάκα Λεωνιδίου": {"lat": 37.148, "lon": 22.893, "orientation": 90},
